...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[AnushkTestSDKManager shared] loginWithApplicationID:@"com.anushkmittal.xkcdOpenSource" allowScreenshots:true logAllTouches:true showButton:true enableConsoleLogging:false saveScreenshotsLocally:true];
